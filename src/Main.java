//вроде всё исправила, насколько поняла..
// если можешь поосветовать хорошую книгу или что-то в дополнение, буду рада, потому что теории на практикуме не хватает
// я часто делаю методом науного тыка на основое пройденных тренажоров и смотрю есть ошибка или нет..
// часто понимая только интуитивно, как должно быть, без возможности даже самой себе объяснить, почему так
