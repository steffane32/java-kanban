...
class EpicStatusTest {
    ...
    void shouldBeNewWhenAllSubtasksNew() {
        Epic epic = manager.createEpic(new Epic(0, "Epic", "Desc", Status.NEW));
        manager.createSubtask(new SubTask(0, "Sub1", "Desc", Status.NEW, epic.getId()));
        manager.createSubtask(new SubTask(0, "Sub2", "Desc", Status.NEW, epic.getId()));
    ...
    void shouldBeInProgressWhenMixedStatuses() {
        Epic epic = manager.createEpic(new Epic(0, "Epic", "Desc", Status.NEW));
        SubTask sub1 = manager.createSubtask(new SubTask(0, "Sub1", "Desc", Status.NEW, epic.getId()));
        SubTask sub2 = manager.createSubtask(new SubTask(0, "Sub2", "Desc", Status.DONE, epic.getId()));
    ...
    void shouldBeInProgressWhenAnyInProgress() {
        Epic epic = manager.createEpic(new Epic(0, "Epic", "Desc", Status.NEW));
        SubTask sub = manager.createSubtask(new SubTask(0, "Sub", "Desc", Status.IN_PROGRESS, epic.getId()));
