...
class TimeOverlapTest {
    ...
    void shouldDetectExactOverlap() {
        ...
        Task task1 = new Task(0, "Task1", "Desc", Status.NEW, Duration.ofHours(1), now);
    ...
    void shouldDetectPartialOverlap() {
        LocalDateTime now = LocalDateTime.now();
        Task task1 = new Task(0, "Task1", "Desc", Status.NEW, Duration.ofHours(2), now);
    ...
    void shouldAllowNonOverlappingTasks() {
        LocalDateTime now = LocalDateTime.now();
        Task task1 = new Task(0, "Task1", "Desc", Status.NEW, Duration.ofHours(1), now);
        Task task2 = new Task(0, "Task2", "Desc", Status.NEW, Duration.ofHours(1), now.plusHours(2));
